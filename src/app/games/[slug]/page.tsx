      ...
      <div className="md:col-span-2">
        ...
        {game.overview && (
          <div className="mt-6 card p-4">
            ...
            <p className="text-sm text-gray-300 whitespace-pre-line">{game.overview}</p>
          </div>
        )}
        ...
        {game.note && settings.showGameNotes && (
          <div className="mt-4 border border-yellow-500/30 bg-yellow-500/10 rounded-lg p-3 text-sm text-yellow-200">
            <p className="font-semibold mb-1">Note</p>
            <p className="whitespace-pre-line">{game.note}</p>
          </div>
        )}
