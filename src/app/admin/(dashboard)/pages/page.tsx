  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/admin/pages/new" className="bg-accent btn-on-accent px-4 py-2 rounded-lg font-semibold">+ Add page</Link>
      </div>
      <p className="text-sm text-gray-400 mb-4">
        Contact has a working form and lives at its own page. Everything you add here (About, Terms,
        FAQ, whatever you need) shows up in the site footer automatically.
      </p>
