    ...
    <div className="grid md:grid-cols-[210px_1fr] gap-8">
      <aside className="card p-4 h-fit sticky top-20">
        ...
        <nav className="flex flex-col gap-1.5 text-sm">
          ...
          {canEditContent && <Link href="/admin/pages" className="hover:text-accent2">Static pages</Link>}
          ...
          <Link href="/admin/account" className="hover:text-accent2">My account</Link>
