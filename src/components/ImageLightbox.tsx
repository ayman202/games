    ...
    <>
      <div className="grid grid-cols-3 gap-2 mt-2">
        {images.map((img, i) => (
          ...
          >
            <Image src={img.url} alt="" fill sizes="(max-width: 768px) 33vw, 11vw" className="object-cover" />
          </button>
        ))}
      </div>
      ...
      {openIndex !== null && (
        ...
        >
          ...
          <div className="relative w-full max-w-3xl aspect-video" onClick={(e) => e.stopPropagation()}>
            <Image src={images[openIndex].url} alt="" fill sizes="(max-width: 768px) 100vw, 768px" className="object-contain" />
          </div>
