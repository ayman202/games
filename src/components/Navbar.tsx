...
export default async function Navbar({ siteName, logoUrl, showAbout, showContact, showCategories, allowThemeToggle, defaultTheme }: Props) {
    ...
    <header className="border-b border-white/10 sticky top-0 bg-bg/90 backdrop-blur z-10">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-5 text-sm text-gray-300">
          ...
          {showAbout && <Link href="/about" className="hover:text-white hidden sm:inline">About</Link>}
